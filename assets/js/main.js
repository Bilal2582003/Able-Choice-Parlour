...
appointmentForm.addEventListener("submit", (e) => {
  ...
  setTimeout(() => {
    ...
    alert(
      "Thank you for your appointment request! We will contact you within 24 hours to confirm your booking.",
    );
...
const galleryData = {
  hair: {
    ...
    description:
      "Discover our premium hair styling services including cutting, coloring, extensions, and special occasion styling. Our expert stylists create personalized looks that enhance your natural beauty.",
    images: [
  ...
  makeup: {
    ...
    description:
      "Professional makeup services for weddings, special events, photoshoots, and everyday glamour. Our makeup artists use premium products to create flawless, long-lasting looks.",
    images: [
  ...
  nails: {
    ...
    description:
      "Creative nail art designs, gel manicures, acrylic extensions, and spa pedicures. We offer the latest trends in nail care with attention to detail and hygiene.",
    images: [
  ...
  facial: {
    ...
    description:
      "Luxury facial treatments including deep cleansing, anti-aging, hydrating, and acne control facials. Our skincare experts use organic products for radiant results.",
    images: [
...
const ApiUrl = "https://cybernsoft.com/Able-Choice/Controllers/Conntect.php";
...
form.addEventListener("submit", async (e) => {
  ...
  formData.append("fromUrl", "Able-Choice-Parlour");
  try {
